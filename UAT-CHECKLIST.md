...
**Sourcing note:** the testimonial is a real Google review, from Jessica
Dickinson, on CuraNatal Health's Google Business listing, which holds a 5.0
rating across 21 reviews. Full text is on file. Not badging an exact
per-review star count since that wasn't independently confirmed, only the
aggregate listing rating.
